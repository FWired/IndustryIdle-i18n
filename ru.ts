export const RU = {
    ...
    SellAll: "Продать всё",
    Change: "Изменить",
    StatisticsBureau: "Отдел статистики",
    ...
    Tips8: "Вы можете увидеть график количества каждого ресурса и его изменения за период времени в Отделе статистики",
    ...
    ChangeNameCooldown: "Вы можете изменять свое имя только один раз в %{час} часа(ов)",
    ...
    AdjacentBonusSquare: "Прилегающая бонусная плитка",
    AdjacentBonusSquareDesc: "Прилегающий бонус на 50% эффективнее, но модификаторы плитки изменяются от -15% до +15%",
    ResourceBoosterSquare: "Плитка усиления ресурсов",
    ResourceBoosterSquareDesc:
        "Ресурсные усилители дают на 25% больше усиления, но их научные затраты и потребление энергии также увеличиваются на 25%",
    ...
    ResourceBoosterPercentageV2: "💡 В эту сумму включено %{percent} прибавки от соседних усилителей ресурсов",
    ...
    ResourceExplorer2DescV2:
        "Исследователи ресурсов производят в 2 раза больше продукции, но потребляют в 2 раза больше энергии. Исследователи ресурсов могут быть усилены усилителями ресурсов, если активна политика Усилитель цепочки поставок и у усилителя есть соседняя шахта с такой же производительностью",
    ...
    SoftwareCompiler: "Компилятор программного обеспечения",
    ...
    PlayerTradeAutoClaim: "Автоматическое подтверждение исполненных сделок",
    ...
    SanJose: "Сан-Хосе",
    SanJoseBonus:
        "<li>Уникальное здание: Производитель микросхем</li><li>Уникальное здание: FaceApp Inc</li><li>Уникальное здание: Bitcoin ферма</li><li>All buildings that consume silicon have max tile modifier</li><li>Солнечные панели производят в 2 раза больше энергии</li><li>Кремнивые рудники увеличивают выработку в двое</li>",
    RotterdamBonusV2:
    ...
    BitcoinMiner: "Bitcoin ферма",
    GalvanicBatteryFactory: "Завод Гальванических Батарей",
    BaseProductionMultiplier: "Базовое производство",
    ShowBreakdown: "Показать подробности",
    HideBreakdown: "Спрятать подробности",
    ...
    ResourceExplorerAll: "Исследователь все ресурсы",
    ResourceExplorerAllDesc:
        "Исследователи ресурсов могут производить все ресурсы, включая те, что отсутсвуют на карте (но это не открывает соответсвующие технологии)",
    ShowResourceInTopBar: "Показывать в верхней строке",
    LeaderboardOptOutDescV2:
        "Вы не будете отображатся в списке лидеров. Эта опция так же отключает торговлю между игроками. Внимание: если захочешь включить снова, твои данные потребуется сбросить",
};
